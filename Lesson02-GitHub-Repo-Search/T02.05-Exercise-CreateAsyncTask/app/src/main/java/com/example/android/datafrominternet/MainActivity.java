...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        masoudCopy = (TextView) findViewById(R.id.masoud);
    }
    ...
    private void makeGithubSearchQuery() {
        ...
        // (4) Create a new GithubQueryTask and call its execute method,
    ...
    // (2) Override the doInBackground method to perform the query.
    // Return the results. (Hint: You've already written the code to perform the query)
